...
| `general-rules` | Core coding rules and anti-pattern prevention for LLMs. |
...
```bash
git clone https://github.com/Gohans1/antigravity-skills.git ~/.gemini/config/skills
```

Restart Antigravity to load the newly cloned skills.
